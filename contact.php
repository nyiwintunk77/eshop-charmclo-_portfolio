                        ...
                        <div class="single-head">
                            ...
                            <div class="single-info">
                                <i class="fa fa-envelope-open"></i>
                                 <h4 class="title">電子メール:</h4>
                                <ul>
                                   <li><a href="mailto:support@charmclo.com">support@charmclo.com</a></li>
                                    <li><a href="mailto:service@charmclo.com">service@charmclo.com</a></li>
                                </ul>
                            </div>
                            <div class="single-info">
