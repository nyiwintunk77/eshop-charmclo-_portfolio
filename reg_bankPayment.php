                        ...
                        <div class="form-main">
                            ...
                            <?php
                                ...
                                try {
                                    ...
                                    $customer_sql = "SELECT c_name, c_address1, c_address2, c_phone, c_zip, c_email, Sum(quantity) as totalQty FROM customers cus INNER JOIN cart c ON cus.c_code = c.c_code INNER JOIN item i ON c.item_id = i.item_id WHERE c.c_code = ? GROUP BY c_name, c_address1, c_address2, c_phone, c_zip, c_email";
                            ...
                            <div class="bank-payment-btns">
                                <form action="reg_add_ordering_forBankPayment.php" method="post">
                                    ...
                                    <input type="hidden" name="c_postalCode" value="<?php echo $postalCode; ?>" />
