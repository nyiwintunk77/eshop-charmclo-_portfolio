                                ...
                                <article class="card-body payment-article">
                                    <div class="convini-type">
                                        ...
                                        <div class="convini-grid-container">
                                            <div class="convini-grid-item">コンビニ名</div>
                                            ...
                                            <div class="convini-grid-item">払込番号</div>
                                        ...
                                        <p style=color:red>&#10070 受付方法：前払い（現金払い）</p>
                                        <p style=color:red>&#10070 以下の「選択」ボタンをクリックし、払込番号をメモし、レジでお支払いをお願いします。</p>
                                        <p style=color:red>&#10070 入金確認が取れましたら「入金確認メール」をお送りさせていただきます。</p>
                                    </div>
                                </article>
                                <div class="back-btn">
                                    <!-- <a href=""><button type="button" class="btn btn-secondary card-submit">SELECT</button></a> -->
                                    <button type="button" class="btn btn-secondary reg-card-submit">選択</button>
                                </div>
                            </div>
