                                    ...
                                    <div class="credit-type">
                                        ...
                                        <div class="myorder-grid-container">
                                            ...
                                            <?php
                                                ...
                                                $qty_arr = array();
                                                try {
                                                    $order_item_sql = "SELECT order_date, order_no, total_amount FROM ordering o WHERE c_code = ? ORDER BY order_no DESC";
                                            ...
                                            ?>
                                                ...
                                                <div class="grid-item"><?php echo "￥" . number_format($row4['total_amount']); ?></div>
                                                <div class="grid-item">
